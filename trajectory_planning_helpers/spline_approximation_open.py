...
def spline_approximation_open(track: np.ndarray,
                         k_reg: int = 3,
                         s_reg: int = 10,
    ...
    track_interp = tph.interp_track_open.interp_track_open(track=track,stepsize=stepsize_prep)
    track_interp_cl = np.vstack(track_interp)
    print(track_interp_cl.shape)
